...
git --version
```
* Share your git username with your TA. You will be invited to an git organization of EECS 330. In which you will create a repository with your name as LastName-kuid (lower case) (for example: mallojula-12345678). Your repo must be private (only you and TAs will be able to see it). Once your repo is created as <img src="pic/git_create.PNG" alt="repo create" width="300"/> </br>
